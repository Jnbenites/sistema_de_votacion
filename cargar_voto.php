    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Gracias por votar</h1>
                <!-- Icon Divider-->
...
<?php 
  //print_r($_POST);
  $id_voto = $_POST['idlistav'];

include 'bd/connection.php';
  $sentencia = $bd->prepare("UPDATE usuario SET voto = ?, estado = ? WHERE id_usu = ?;");
  $resultado = $sentencia->execute([$id_voto,"1", $id_usua]);
  ?>
