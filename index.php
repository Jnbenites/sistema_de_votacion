    ...
    <a class="navbar-brand js-scroll-trigger" href="#page-top">Sistema de votacion</a>
        ...
        <header class="masthead bg-primary text-white">
            <div class="container d-flex align-items-center text-center flex-column">
                ...
                <img class="masthead-avatar mb-10" src="assets/img/caja.png" alt="" />
                    <form method="POST" action="loginProceso.php">
                    <br>
                      <label>Cedula</label>
                      <input class="form-control" required="" type="number" name="txtusu">
                      <label>Contraseña</label>
                      <input class="form-control"  required="" type="password" name="txtpass">
                      <br>
