...
<td><?php echo "<font size='2' color='white'>Bienvenido: </font>"."<font size='2' color='black'>".$_SESSION["nombrecompleto"]."</font>";?></td>

<td><?php echo "<font size='2' color='white'>Cedula: </font>"."<font size='2' color='black'>".$_SESSION["nombre"]."</font>";?></td>
</div>
