        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <div class="divider-custom">
                    <div class="p-3 mb-2 bg-white text-dark"><?php echo "Bienvenido: ".$_SESSION["nombrecompleto"];?></div>
                    <br>
                    <div class="p-3 mb-2 bg-white text-dark"><?php echo "Cedula: ".$_SESSION["nombre"];?></div> 
                    <hr>        
                </div>
...
<?php 
  foreach ($lista as $dato) {
    ?>
<form method="POST" action="cargar_voto.php">
    <tr>
      <form method="POST" action="cargar_voto.php">
     ...
     <!--<?php echo $dato->id_lista?> -->
      <td> <button class="btn btn-primary" type="HIDDEN" name="idlistav" value="<?php echo $dato->id_lista?>">votar</button></td>
      </div>
    </form>
    </tr>
    <?php
...
<section>
  ...
  <div class="card align-items-right">
    <input type="HIDDEN" name="idlistav" value="0">
    <button class="btn btn-danger center-block">Anular voto</button>
  </div>
  </form>
</section>
