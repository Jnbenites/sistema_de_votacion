                ...
                <?php 
                  foreach ($usuarios as $dato) {
                    ...
                    <tr>
                      ...
                      <td><?php echo $dato->clave_usu?></td>
                      <td><?php echo $dato->estado?></td>
                      <td><a href="editar_alumno.php?id=<?php echo $dato->id_usu;?> ">Editar</a></td>
                      <td><a href="eliminar_alumno.php?id=<?php echo $dato->id_usu;?>">Eliminar</a></td>
                    </tr>
                    <?php
                  }
                ?>
